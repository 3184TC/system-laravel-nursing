...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-3 font-weight-bold"> ENFERMERIA</span>
    </a>
  </div>
    ...
    <ul class="navbar-nav">
     ...
     {{-- <li class="nav-item">
        <a class="nav-link {{ (Request::is('personas') ? 'active' : '') }}" href="{{ url('personas') }}">
          ...
          <span class="nav-link-text ms-1">Registrar Personas</span>
        </a>
      </li>--}}
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('establecimientos') ? 'active' : '') }}" href="{{ url('establecimientos') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Registrar Establecimiento</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('asistenciales') ? 'active' : '') }}" href="{{ url('asistenciales') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Registrar Doc. Asistencial</span>
        </a>
      </li>
      <li class="nav-item mt-3">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">ASIGNACIONES</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('asignaciones') ? 'active' : '') }}" href="{{ url('asignaciones') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Asignar Establecimiento</span>
        </a>
      </li>
{{--     <li class="nav-item">
        <a class="nav-link {{ (Request::is('encargados') ? 'active' : '') }}" href="{{ url('encargados') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <span class="nav-link-text ms-1">Asignar Encargado</span>
        </a>
      </li>--}}
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('solicituds') ? 'active' : '') }}" href="{{ url('solicituds') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('certificados') ? 'active' : '') }}" href="{{ url('certificados') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>settings</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
